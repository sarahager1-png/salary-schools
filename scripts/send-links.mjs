...
הרשת עוברת למערכת אחת לניהול שכר המורות, וזה הקישור האישי שלך ל${school}.

*מה צריך למלא:*
לכל מורה — שם, ת.ז., מסלול (אופק חדש / עולם ישן), תואר, דרגה, ותק ושעות פרונטליות. אחוז המשרה מחושב לבד.
אם מורה יצאה לחל"ד — יש בורר סטטוס עם תאריך.
