-- rollback של 20260910150000_link_lock_on_10th: ההגדרות החיות כפי שהיו ב-10.9.2026 לפני ההרצה
...
drop function if exists private.link_locked(text);
-- העמודה lock_due נשארת (לא מזיקה); להסרה: alter table public.months drop column lock_due;
