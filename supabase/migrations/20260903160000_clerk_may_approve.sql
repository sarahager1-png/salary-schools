-- "תשתף את אסתר גם באישורים של המורים" (שרה, 3.9.2026).
--
-- עד עכשיו חשבת השכר יכלה רק לבטל אישור ("האישור הוא של שרה", 1.9) —
-- מהיום היא גם מאשרת. approved_by נחתם בשרת, ולכן תמיד ידוע מי אישרה.
