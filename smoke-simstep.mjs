...
try {
  ...
  // חטיבת ביניים: 4 פרטני, 9 שהייה. אחוז המשרה הוא זה ששמור על המורה (92%),
  // ולא נגזר מחדש מהשעות — ומכאן פרטני 4 (4×0.92) ושהייה 8 (9×0.92).
  for (const [label, expect] of [['% משרה','92%'], ['פרונטלי','24'], ['פרטני',"4 ש'"],
                                 ['שהייה',"8 ש'"], ['שלב','חטיבת ביניים'], ['גיל','50'], ['גמול','מחנך'], ['תואר','תואר ראשון'], ['דרגה','דרגה 5']]) {
